...
function fft_1024ch_core_config(this_block)
  ...
  % Revision History:
  %
  %   20-Dec-2011  (12:46 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /scratch/zaki/workspace/pocket_corr/fft_1024ch_core.vhd
  %
  %
  ...
  this_block.addSimulinkInport('po1');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('po1').width ~= 18);
      this_block.setError('Input data type for port "po1" must have width=18.');
    end
